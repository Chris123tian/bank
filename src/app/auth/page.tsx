    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4 sm:p-6 relative">
      ...
      <Link href="/" className="mb-8 flex items-center gap-2 group">
        ...
        <div className="flex flex-col -space-y-1">
          <span className="font-headline font-black text-xl sm:text-2xl tracking-tighter text-primary leading-none uppercase">City Bank</span>
          <span className="text-[7px] sm:text-[8px] font-black tracking-[0.2em] text-accent uppercase">Global</span>
        </div>
      </Link>
