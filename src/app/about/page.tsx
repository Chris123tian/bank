    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 selection:bg-accent/30">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
            <div className="space-y-8">
              ...
              <p className="text-lg text-slate-600">
                City International Bank operates at the intersection of global trade and institutional finance. With strategic hubs in the world's most vital financial markets, we ensure our clients have 24/7 access to liquidity.
              </p>
      ...
      <footer className="bg-slate-950 py-16 border-t border-white/5 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center space-y-4">
          ...
          <p className="text-[8px] text-slate-600 font-bold uppercase tracking-widest">{t('footer_branches')}</p>
        </div>
      </footer>
    </div>
  );
